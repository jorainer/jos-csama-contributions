...
knitr::include_graphics("images/correspondence_01.png")
```
...
```{r echo = FALSE, out.width = "700px"}
knitr::include_graphics("images/correspondence_02.png")
```
...
```{r echo = FALSE, out.width = "700px"}
knitr::include_graphics("images/correspondence_03.png")
```
...
TODO add content:
- image describing the alignment
- available methods
- what is the result? (m/z - rt ranges).
