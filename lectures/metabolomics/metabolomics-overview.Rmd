---
title: "Metabolomics, Introduction and Data Analysis"
...
library(webshot)
install_phantomjs()
fn <- paste0("file://", normalizePath("metabolomics-overview.html"))
rmdshot("metabolomics-overview.Rmd", "metabolomics-overview.pdf")
-->
...
Targeted mass spectrometry is designed to detect and
...
<div style = "font-size: 300%; position:absolute; top:50%; left:5%">
<h1>MS data analysis in *R*</h1>
</div>
...
<img src="images/2026-01-08-153057_hyprshot.png" width=700>
</div>
...
<div>
https://RforMassSpectrometry.github.io/Metabonaut
<img src="images/2026-01-08-153144_hyprshot.png" width=700>
</div>

<div style="position:absolute; left:5%; top:85%;">
- different workflows/use cases available
</div>
...
<div>
https://RforMassSpectrometry.github.io/Metabonaut
<img src="images/2026-01-08-153557_hyprshot.png" width=700>
</div>


<div style="position:absolute; left:5%; top:85%;">
- pre-rendered for easy browsing
- docker image for interactive use
</div>

## {.build}

<div style="position:absolute; top:48%; left:5%; font-size: 200%">
